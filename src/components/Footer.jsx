    ...
    <footer className="bg-black text-white">
      <div className="px-6 md:px-12 py-16 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-12">
          {links.map((link, idx) => (
            <motion.div
              ...
              role="button"
              className="group border border-gray-700 p-4 bg-white text-black cursor-pointer relative text-center "
            >
              ...
              {/* Hover underline */}
              <div className="absolute bottom-0 left-1/2 w-0 h-[2px] bg-black transition-all duration-300 group-hover:w-3/4 group-hover:left-1/8"></div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="text-center mb-12">
          <p className="text-sm tracking-widest mb-3">ACCEPTED PAYMENTS</p>
            ...
            <>
              ...
              >
                <div className="bg-white max-w-md w-full p-8 border border-gray-200 relative ">
                  ...
                  {/* Title */}
                  <h3 className="text-sm tracking-widest font-medium mb-4 text-black">
